###########################################################################
## Makefile generated for component 'ultrasonic_sensor'. 
## 
## Makefile     : ultrasonic_sensor.mk
## Generated on : Thu Nov 02 12:41:41 2023
...
DEFINES_STANDARD = -DMODEL=ultrasonic_sensor -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_Ultrasonic.o xcp_ext_mode.o ultrasonic_sensor.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/ultrasonic_sensor_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ultrasonic_sensor_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/ultrasonic_sensor_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ultrasonic_sensor.o : $(START_DIR)/ultrasonic_sensor_ert_rtw/ultrasonic_sensor.c
	$(CC) $(CFLAGS) -o "$@" "$<"
