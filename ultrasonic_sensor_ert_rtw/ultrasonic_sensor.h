...
#include "ultrasonic_sensor_types.h"
...
} B_ultrasonic_sensor_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  codertarget_arduinobase_inter_T obj; /* '<Root>/Ultrasonic Sensor' */
} DW_ultrasonic_sensor_T;

/* Real-time Model Data Structure */
struct tag_RTM_ultrasonic_sensor_T {
...
/* Block signals (default storage) */
extern B_ultrasonic_sensor_T ultrasonic_sensor_B;

/* Block states (default storage) */
extern DW_ultrasonic_sensor_T ultrasonic_sensor_DW;

/* Model entry point functions */
extern void ultrasonic_sensor_initialize(void);
extern void ultrasonic_sensor_step(void);
extern void ultrasonic_sensor_terminate(void);

/* Real-time Model object */
extern RT_MODEL_ultrasonic_sensor_T *const ultrasonic_sensor_M;
