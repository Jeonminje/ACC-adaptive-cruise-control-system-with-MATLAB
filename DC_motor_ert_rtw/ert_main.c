...
void rt_OneStep(void)
{
   ...
   */
  DC_motor_SetEventsForThisBaseStep(eventFlags);
  ...
  currentTime = (extmodeSimulationTime_T) ((DC_motor_M->Timing.clockTick0 * 1) +
    0)
    ;
  DC_motor_step0();
  ...
  if (need2runFlags[1]) {
    ...
    {
     case 1 :
      currentTime = (extmodeSimulationTime_T) ((DC_motor_M->Timing.clockTick1 *
        5) + 0)
        ;
      DC_motor_step1();
...
int main(void)
{
  ...
  errorCode = extmodeInit(DC_motor_M->extModeInfo, &rtmGetTFinal(DC_motor_M));
  if (errorCode != EXTMODE_SUCCESS) {
  ...
  if (errorCode == EXTMODE_SUCCESS) {
    ...
    if (extmodeStopRequested()) {
      rtmSetStopRequested(DC_motor_M, true);
    }
  }
  ...
  runModel = !extmodeSimulationComplete() && !extmodeStopRequested() &&
    !rtmGetStopRequested(DC_motor_M);
